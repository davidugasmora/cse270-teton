...
class TestSmokeTestSuite():
  ...
  def test_joinPageTest(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Ugas")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("DUM CO")
  ...
  def test_adminPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("David")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("Ugas")
